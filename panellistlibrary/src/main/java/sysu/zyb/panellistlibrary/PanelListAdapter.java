...
public abstract class PanelListAdapter {
     ...
     */
    private int titleWidth = 150;//标题和左侧列表头的宽度
    private int titleHeight = 100; //标题和上方列表头的高度
    private int columnItemHeight = 100; //调整后未起作用
...
//      lv_column.setDivider(context.getResources().getDrawable(R.drawable.column_item_divider));
        ...
        //重中之重 linyuan添加 解决 child already has a parent 问题
